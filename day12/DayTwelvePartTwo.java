...
class DayTwelvePartTwo {
    ...
    private static List<int[]> startNodes = new ArrayList<int[]>();
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < startNodes.size(); i++) {
            ...
            graph.get(startNode[0]).get(startNode[1]).cost = 0;
    ...
    public static void addRowToMap(String line) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            if (arr[i].equals("S") || arr[i].equals("a")) {
                startNodes.add(new int[] { currentRow, i });
                currentNode.cost = 0;
                arr[i] = "a";
